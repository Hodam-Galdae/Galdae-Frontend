                ...
                <View>
                    ...
                    <View style={styles.fromToContainer}>
                        ...
                        <View style={styles.fromContainer}>
                            ...
                            <BasicText text={item.titleLeft} style={!item.sameGenderYN ? styles.fromMainLocationCom : styles.fromMainLocation} />            </View>
                        {/** */}
                        <SVG name={'arrow_forward'} />
                        {/* 도착지 정보 */}
                        <View style={styles.toContainer}>
                            {/* <SVG name={!item.isSameGender && item.passengerGenderType === 'SAME_GENDER' ? 'Location1' : 'Location'} /> */}
                            <BasicText text={item.titleRight} style={!item.sameGenderYN ? styles.fromMainLocationCom : styles.fromMainLocation} />
